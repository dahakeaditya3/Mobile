...
export class AboutComponent {
  ...
  attorneys = [
    { name: 'Wade Warren', role: 'Attorney', img: 'assets/images/Aditya.jpg' },
    { name: 'Jerome Bell', role: 'Attorney', img: 'assets/images/Aditya.jpg' },
    { name: 'Arlene McCoy', role: 'Attorney', img: 'assets/images/Aditya.jpg' }
  ];
